...
public class Link   {
   ...
   * @return rel
  **/
  @ApiModelProperty(required = true, value = "Relationship of the link. Current links include: * self: when requesting a single memberId * coverages: link to the member's coverages")
  @NotNull
